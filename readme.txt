...
* Fixed: Fatal error caused in register_activation_hook not calling class properly.
* These things happen when the entire plugin is rewritten.

= 1.8.1 =

* Free License Key required for plugin support, and to activate advanced plugin features.
* Fixed: File path threw an error on some operating systems.
